...
(() => {
  ...
  t.r(e),
    t.d(e, {
      checkAuthenticatedRoute: () => h,
      checkUnauthenticatedRouteOnly: () => f,
      getAccessToken: () => s,
      getLogout: () => d,
      putAccessToken: () => u,
      removeAccessToken: () => c,
  ...
  function r() {
    return (
      ...
      (r = n.split("/")),
      (t = { resource: r[1] || null, id: r[2] || null }),
      (e = ""),
  ...
  function o(t) {
    ...
    if (n || !document.startViewTransition) {
      var o = Promise.resolve(r()).then(function () {});
      return {
  ...
  t.r(n), t.d(n, { login: () => L, register: () => M });
  var a = "accessToken",
    i = "https://gejalaku-be.vercel.app";
  function s() {
    try {
      var t = localStorage.getItem(a);
      return (
        console.log({ accessToken: t }),
        null === t || "null" === t || "undefined" === t ? null : t
      );
    } catch (t) {
  ...
  function u(t) {
    try {
      return localStorage.setItem(a, t), !0;
    } catch (t) {
  ...
  function f(t) {
    ...
    return (
      ...
      l.includes(e) && n ? ((location.hash = "/"), null) : t
    );
  }
  function h(t) {
    return s() ? t : ((location.hash = "/login?c=true"), null);
  }
  function d() {
    c();
  }
  ...
  function y() {
    ...
    function E(e, n) {
      ...
      var a = l(o, e.i, n.arg);
      if ("throw" === a.type)
        return (n.method = "throw"), (n.arg = a.arg), (n.delegate = null), f;
      var i = a.arg;
      return i
        ? i.done
          ? ((n[e.r] = i.value),
    ...
    function O(t) {
      (this.tryEntries = [[-1]]), t.forEach(j, this), this.reset(!0);
    }
    function P(e) {
      if (null != e) {
        var n = e[a];
      ...
      (O.prototype = {
        ...
        finish: function (t) {
          for (var e = this.tryEntries.length - 1; e >= 0; --e) {
            ...
            if (n[2] === t) return this.complete(n[4], n[3]), S(n), f;
          }
        },
        catch: function (t) {
          for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 3:
                              ...
                              return (
                                x(j, this).showErrorMessage(
                                  n.error || "Registration failed."
                                ),
                                t.abrupt("return")
                              );
                            case 8:
                              x(O, this).putAccessToken(n.accessToken),
                                x(O, this).showSuccessMessage(
                            ...
                            case 13:
                              (t.prev = 13),
                                (t.t0 = t.catch(0)),
                                x(j, this).showErrorMessage(
                                  t.t0.message || "Registration failed."
                                );
                            case 16:
                            case "end":
                              return t.stop();
            ...
            switch ((t.prev = t.next)) {
              case 0:
                return (
                  (n = e.email),
                  (r = e.password),
                  (o = JSON.stringify({ email: n, password: r })),
                  (t.next = 4),
                  fetch(F.REGISTER, {
                    method: "POST",
    ...
    function w(t, e) {
      function n(o, a, i, s) {
        ...
        if ("throw" !== u.type) {
          var c = u.arg,
            f = c.value;
          return f && "object" == R(f) && r.call(f, "__await")
            ? e.resolve(f.__await).then(
                function (t) {
                  n("next", t, i, s);
                },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (e.textContent = t),
                ...
                document.getElementById("register-form").appendChild(e),
                setTimeout(function () {
                  e.remove();
                }, 3e3);
            },
  ...
  function $() {
    var t = document.getElementById("password"),
      e = document.getElementById("confirm-password"),
      n = document.getElementById("password-match-message");
    e.addEventListener("input", function () {
      if ("" === n.value || "" === e.value) return (n.textContent = "");
      e.value === t.value
        ? ((n.textContent = "Passwords match"),
          (n.className = "text-green-600"))
                ...
                switch ((e.prev = e.next)) {
                  ...
                  case 5:
                    return (
                      ...
                      (e.next = 8),
                      ((i = J), (s = t), i.get(V(i, s))).register(a)
                    );
                  case 8:
                  case "end":
                    return e.stop();
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 3:
                              ...
                              return (
                                at(ut, this).showErrorMessage(
                                  "Login failed. Please check your username and password."
                                ),
                                t.abrupt("return")
                              );
                            case 7:
                              at(lt, this).putAccessToken(r.data.accessToken),
                                at(lt, this).showSuccessMessage(
                                  "Login successful!"
                                ),
                                "true" ===
    ...
    function w(t, e) {
      function n(o, a, i, s) {
        ...
        if ("throw" !== u.type) {
          var c = u.arg,
            f = c.value;
          return f && "object" == ht(f) && r.call(f, "__await")
            ? e.resolve(f.__await).then(
                function (t) {
                  n("next", t, i, s);
                },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (e.innerHTML = t),
                ...
                document.getElementById("login-form").appendChild(e),
                e.remove();
            },
          },
        ]),
    ...
    function w(t, e) {
      function n(o, a, i, s) {
        ...
        if ("throw" !== u.type) {
          var c = u.arg,
            f = c.value;
          return f && "object" == jt(f) && r.call(f, "__await")
            ? e.resolve(f.__await).then(
                function (t) {
                  n("next", t, i, s);
                },
                      ...
                      case 0:
                        document.getElementById("main-content"),
                          !!localStorage.getItem("accessToken") &&
                            (e = document.getElementById("register-btn")) &&
                            (e.style.display = "none"),
                          (n = document.getElementById("register-btn")) &&
                            (n.onclick = function () {
                              window.location.hash = "/register";
                            }),
                          (r = document.getElementById(
                            "cek-gejala-btn-footer"
                          )) &&
                            (r.onclick = function () {
                              window.location.hash = "/check-symptom";
                            });
  ...
  function Bt() {
    ...
    function w(t, e) {
      function n(o, a, i, s) {
        ...
        if ("throw" !== u.type) {
          var c = u.arg,
            f = c.value;
          return f && "object" == Lt(f) && r.call(f, "__await")
            ? e.resolve(f.__await).then(
                function (t) {
                  n("next", t, i, s);
                },
    ...
    function S(e) {
      ...
      throw new TypeError(Lt(e) + " is not iterable");
    }
    return (
      (d.prototype = p),
      u(g, "constructor", p),
      ...
      Bt().mark(function t() {
        ...
        return Bt().wrap(function (t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                return (t.next = 2), fetch(SYMTOPMS_BY_BODYPART);
              case 2:
                return (e = t.sent), (t.next = 5), e.json();
              case 5:
                return (
                  (n = t.sent),
                  t.abrupt("return", Kt(Kt({}, n), {}, { ok: e.ok }))
                );
              case 7:
              case "end":
                return t.stop();
            ...
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  return (
                    ...
                    fetch(PREDICT_SYMPTOMS, {
                      ...
                      headers: { "Content-Type": "application/json" },
                      body: JSON.stringify({
                        symptoms: this.selectedSymptoms.map(function (t) {
                          return t.id;
                        }),
                      }),
                      mode: "cors",
                ...
                case 6:
                  return (
                    (r = t.sent),
                    t.abrupt("return", Kt(Kt({}, r), {}, { ok: n.ok }))
                  );
                case 8:
                case "end":
                  return t.stop();
  ...
  "".concat(i, "/symptoms-by-bodypart"), "".concat(i, "/predict-symptoms");
  var se = new WeakSet(),
    ue = (function () {
      return (
        (t = function t() {
        ...
        (e = [
          {
            key: "renderSelectedSymptoms",
            value: function () {
              return 0 === this.selectedSymptoms.length
                ? '<li class="px-4 py-8 text-center text-gray-400 text-sm">Belum ada gejala yang dipilih.</li>'
                : this.selectedSymptoms
                    .map(function (t) {
                      return '\n            <li class="flex justify-between items-center px-4 py-3 text-gray-800 text-md transition-all hover:bg-gray-50">\n                <span class="font-medium">'
                        ...
                        .concat(
                          null == t ? void 0 : t.name,
                          '" class="text-gray-400 hover:text-red-500 transition-colors remove-symptom-btn" data-symptom-id="'
                        )
                        .concat(
                          null == t ? void 0 : t.id,
                          '">\n                    <i class="fas fa-times"></i>\n                </button>\n            </li>\n        '
          ...
          {
            key: "renderSymptomCategories",
            value: function () {
              var t = this;
              return this.symptomsByCategory
                ? Object.entries(this.symptomsByCategory)
                    .map(function (e) {
                      var n = ne(e, 2),
                        r = n[0],
                        o = n[1],
                        ...
                        i = o
                          .slice(0, 15)
                          .map(function (e) {
                            var n = t.selectedSymptoms.some(function (t) {
                              return t.id === e.id;
                            });
                    ...
                    .join("")
                : '<p class="text-gray-500">Memuat kategori gejala...</p>';
            },
          },
          {
            key: "renderAutocompleteSuggestions",
            value: function () {
              var t = this,
                e = this.allSymptoms.filter(function (e) {
                  return e.name
                    .toLowerCase()
                    .includes(t.symptomSearchQuery.toLowerCase());
                });
              return 0 === e.length && this.symptomSearchQuery
                ? '<div class="p-4 text-sm text-gray-500">Gejala tidak ditemukan.</div>'
                : e
                    .map(function (e) {
                      var n = t.selectedSymptoms.some(function (t) {
                        return t.id === e.id;
                      });
                      return '\n        <div \n            class="px-4 py-2 text-md cursor-pointer hover:bg-blue-50 autocomplete-item '
                        .concat(
                          n
                          ...
                          case 0:
                            return t.abrupt(
                              ...
                              '     \n      <main class="w-full max-w-7xl mx-auto flex-auto py-8 lg:py-12 px-4 sm:px-6 lg:px-8">\n        \x3c!-- Main Content Grid --\x3e\n        <div class="grid lg:grid-cols-5 lg:gap-12">\n        \x3c!-- Left Side (Inputs) --\x3e\n        <div class="lg:col-span-3 flex flex-col gap-10">\n          \x3c!-- Page Header --\x3e\n          <div class="mb-4">\n          <h1 class="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">Cek Gejala Kesehatan Anda</h1>\n          <p class="text-gray-600 mt-3 text-lg">Pilih gejala yang Anda rasakan untuk mendapatkan analisa kemungkinan penyebabnya. Semakin banyak gejala, semakin akurat hasilnya.</p>\n          </div>\n          \n          <div class="sticky top-0 z-10 py-6 -my-6">\n          <label \n            for="symptoms-input" \n            class="block font-semibold text-lg text-gray-800 mb-3 bg-white/40 py-1 backdrop-blur-md w-fit rounded-lg"\n            style="backdrop-filter: blur(8px);"\n          >\n            Cari Semua Gejala\n          </label>\n          <section>\n            <form id="symptom-form" autocomplete="off" onsubmit="return false;">\n            <div class="relative w-full">\n              <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">\n              <i class="fas fa-search text-gray-400"></i>\n              </div>\n              <input\n              id="symptoms-input"\n              type="text"\n              placeholder="Contoh: Sakit kepala, demam, batuk..."\n              class="w-full rounded-lg border border-gray-300 bg-white/60 backdrop-blur-md py-3 pl-12 pr-4 text-md placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm"\n              value="'
                                ...
                                .concat(
                                  0 === this.selectedSymptoms.length
                                    ? "disabled"
                                    : "",
                                  "\n            >\n            Analisa Gejalaku\n          </button>\n          </div>\n        </aside>\n        </div>\n      </main>\n      "
                                )
                  ...
                  return Zt().wrap(
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            if (null !== this.symptomsByCategory) {
                              t.next = 17;
                              break;
                            }
                            return (t.prev = 1), (t.next = 4), Yt();
                          case 4:
                            t.sent.ok &&
                              ((this.symptomsByCategory =
                                data.symptomsByBodyPart),
                              (this.allSymptoms = Object.entries(
                                data.symptomsByBodyPart
                              )
                                .filter(function (t) {
                                  return "umum" !== ne(t, 1)[0];
                                })
                                .flatMap(function (t) {
                                  return ne(t, 2)[1];
                                })),
          ...
          },
          {
            ...
            value: function (t) {
              t &&
                !this.selectedSymptoms.some(function (e) {
                  return e.id === t.id;
                }) &&
                (this.selectedSymptoms.push(t), this.rerender());
            },
          },
          {
            key: "removeSymptom",
            value: function (t) {
              (this.selectedSymptoms = this.selectedSymptoms.filter(function (
                e
              ) {
                return e.id !== t;
              })),
  ...
  function ce() {
    var t = this;
    document.querySelectorAll(".common-symptom-btn").forEach(function (e) {
      e.addEventListener("click", function () {
        var n = JSON.parse(e.getAttribute("data-symptom"));
        t.selectedSymptoms.some(function (t) {
          return t.id === n.id;
        })
          ? t.removeSymptom(n.id)
          : t.addSymptom(n);
      });
    }),
      document.querySelectorAll(".remove-symptom-btn").forEach(function (e) {
        e.addEventListener("click", function () {
          var n = e.getAttribute("data-symptom-id");
          t.removeSymptom(n);
        });
      });
    var e = document.getElementById("symptoms-input"),
      n = document.getElementById("autocomplete-suggestions"),
      r = -1;
    if (e && n) {
      var o = function () {
          (n.innerHTML = t.renderAutocompleteSuggestions()), (r = -1);
        },
        a = function () {
          var t = n.querySelectorAll(".autocomplete-item");
          t.forEach(function (t, e) {
            t.classList.toggle("suggestion-active", e === r);
          }),
            t[r] && t[r].scrollIntoView({ block: "nearest" });
        };
      e.addEventListener("focus", function () {
        (t.isDropdownVisible = !0), n.classList.remove("hidden"), o();
      }),
        e.addEventListener("blur", function () {
          setTimeout(function () {
            (t.isDropdownVisible = !1), n.classList.add("hidden"), (r = -1);
          }, 150);
        }),
        e.addEventListener("input", function (e) {
          (t.symptomSearchQuery = e.target.value),
            t.isDropdownVisible ||
              ((t.isDropdownVisible = !0), n.classList.remove("hidden")),
            o();
        }),
        e.addEventListener("keydown", function (o) {
          ...
          i.length &&
            ("ArrowDown" === o.key
              ? (o.preventDefault(), (r = (r + 1) % i.length), a())
              : "ArrowUp" === o.key
              ? (o.preventDefault(), (r = (r - 1 + i.length) % i.length), a())
              : ("Enter" !== o.key && "Tab" !== o.key) ||
                (e.focus(),
                t.isDropdownVisible &&
                  r > -1 &&
                  (o.preventDefault(),
                  i[r].dispatchEvent(
                    new Event("mousedown", { bubbles: !0 })
                  ))));
        }),
        n.addEventListener("mousedown", function (e) {
          var n = e.target.closest(".autocomplete-item");
          if (n && "false" === n.dataset.selected) {
            var r = JSON.parse(n.getAttribute("data-symptom"));
            (t.symptomSearchQuery = ""), t.addSymptom(r);
          }
        });
    }
    document.getElementById("check-symptom-button").addEventListener(
      "click",
      ee(
        Zt().mark(function e() {
          var n, r;
            ...
            function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 8:
                    (r = e.sent),
                      (window.location.hash = "/summary?id=".concat(r));
                  case 10:
                    e.next = 16;
                    break;
                  case 12:
                    (e.prev = 12),
                      ...
                      alert(
                        "Gagal menyimpan hasil analisa. Silakan coba lagi."
                      );
                  case 16:
                  case "end":
                    return e.stop();
  ...
  function le() {
    return new Promise(function (t, e) {
      var n = indexedDB.open("SymptomAnalyzerDB", 1);
      (n.onupgradeneeded = function (t) {
        var e = t.target.result;
        e.objectStoreNames.contains("predictions") ||
          e.createObjectStore("predictions", {
            keyPath: "id",
            autoIncrement: !0,
          });
      }),
          ...
          function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  return (
                    (t.prev = 0), (t.next = 3), ie(se, this, le).call(this)
                  );
                case 3:
                  return (
                    (n = t.sent),
                    (r = n.transaction(["predictions"], "readwrite")),
                    (o = r.objectStore("predictions")),
                    (a = o.add(e)),
                    t.abrupt(
                      "return",
                      new Promise(function (t, e) {
                        (a.onsuccess = function () {
                          console.log(
                            "Prediction saved to IndexedDB with ID:",
                            a.result
                          ),
                            t(a.result);
                        }),
                ...
                case 10:
                  (t.prev = 10),
                    (t.t0 = t.catch(0)),
                    console.error("Could not save prediction to DB:", t.t0);
                case 13:
                case "end":
                  return t.stop();
              }
    ...
    function w(t, e) {
      function n(o, a, i, s) {
        ...
        if ("throw" !== u.type) {
          var c = u.arg,
            f = c.value;
          return f && "object" == de(f) && r.call(f, "__await")
            ? e.resolve(f.__await).then(
                function (t) {
                  n("next", t, i, s);
                },
  ...
  function ye(t, e) {
    for (var n = 0; n < e.length; n++) {
      ...
      (r.enumerable = r.enumerable || !1),
        (r.configurable = !0),
        "value" in r && (r.writable = !0),
        Object.defineProperty(t, ve(r.key), r);
    }
  }
  function ve(t) {
    var e = (function (t) {
          ...
          value: function () {
            setTimeout(function () {
              ...
              if (window.location.hash) {
                var e = window.location.hash.match(/[?&]id=([^&]+)/);
                e && (t = parseInt(e[1], 10));
              }
              window.location.hash = t ? "/summary?id=".concat(t) : "/summary";
            }, 1e3);
          },
        },
      ]),
          ...
          value: function () {
            try {
              ...
              this.view.showError("Failed to print results."),
                console.error("Error handling print:", t);
            }
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t) {
            try {
              ...
              this.view.showError("Failed to navigate to ".concat(t, ".")),
    ...
    Ie = (function () {
      return (
        ...
        (e = [
                      ...
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              (n =
                                '\n        <main class="max-w-xl flex-auto mx-auto py-8 text-center"><p class="text-red-600 bg-red-100 p-4 rounded-lg">'.concat(
                                  e,
                                  "</p></main>\n    "
                                )),
                              (document.querySelector("main").outerHTML = n),
                              (t.next = 5),
                              new Promise(function (t) {
                                return setTimeout(t, 0);
                              })
          ...
          },
          {
            ...
            value: function () {
              if (
                ...
                !this.summary || !this.summary.symptoms)
              )
                return "";
              var t = this.summary.symptoms
                .map(function (t) {
                  return '<span class="bg-gray-200 text-gray-800 text-sm font-medium mr-2 mb-2 px-3 py-1 rounded-full">'.concat(
                    t.name,
                    "</span>"
                  );
                })
          ...
          {
            key: "renderPredictedCondition",
            value: function () {
              if (!this.summary) return "";
              var t = this.summary,
                e = t.predictedDisease,
                n = t.confidence,
                r = parseFloat(n),
                o = r > 0.7 ? "Tinggi" : r > 0.4 ? "Sedang" : "Rendah",
                a = r > 0.7 ? "green" : r > 0.4 ? "yellow" : "red";
              return '\n      <section class="bg-white rounded-lg shadow-sm">\n        <h2 class="text-lg font-semibold text-gray-900 border-b border-gray-200 px-4 py-3">Hasil Prediksi</h2>\n        <div class="px-4 py-3">\n            <div class="flex justify-between items-center">\n                <span class="font-semibold text-xl text-gray-800">'
                ...
                .concat(a, "-800 bg-")
                .concat(a, '-100 rounded-full px-3 py-1">')
                .concat((100 * r).toFixed(0), "% (")
                .concat(
                  o,
                  ")</span>\n            </div>\n        </div>\n      </section>\n    "
                );
          ...
          {
            key: "renderConditionDetails",
            value: function () {
              var t, e;
              if (!this.summary || !this.summary || !this.summary.details)
                return "";
              var n = this.summary,
                r = n.details,
                o = n.predictedDisease,
                a =
                  (null === (t = r.description) || void 0 === t
                    ? void 0
                    : t.Description) || "Informasi tidak tersedia.",
                i = r.precautions
                  ? Object.values(r.precautions).filter(function (t) {
                      return t !== o;
                    })
                  : [],
                s =
                  null !== (e = r.drugs) && void 0 !== e && e.drug
                    ? [r.drugs.drug]
                    : [],
                u =
                  i.length > 0
                ...
                c =
                  s.length > 0
                    ? s
                        ...
                        .join("")
                    : "<li>Informasi tidak tersedia.</li>";
              return '\n        <div class="space-y-4">\n            <h2 class="text-2xl font-bold text-gray-900 px-1">Detail untuk: '
                .concat(
                  o,
                  '</h2>\n            <section class="bg-white rounded-lg shadow-sm">\n                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 px-4 py-3">Deskripsi</h3>\n                <p class="text-gray-700 text-base px-4 py-3 leading-relaxed">'
                )
                .concat(
                  a,
          ...
          },
          {
            ...
            value: function () {
              return this.summary
                ...
                : '<main class="max-w-xl flex-auto mx-auto py-8 text-center"><p>Data prediksi tidak ditemukan.</p></main>';
            },
          },
          {
            key: "getPredictions",
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 2:
                          return (
                            (e = t.sent),
                            (n = e.transaction(["predictions"], "readonly")),
                            (r = n.objectStore("predictions")),
                            (o = r.getAll()),
                            t.abrupt(
                              "return",
                              new Promise(function (t, e) {
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              (this.presenter = new ke({ view: this })),
                          ...
                          case 5:
                            ...
                            return (
                              this.showError(
                                "ID prediksi tidak ditemukan di URL."
                              ),
                              t.abrupt("return")
                            );
                          case 11:
                          ...
                          case 19:
                            return (
                              console.warn(
                                'Data prediksi dengan ID "'.concat(
                                  n,
                                  '" tidak ditemukan. Menggunakan data contoh.'
                                )
                              ),
                              (t.next = 22),
                              this.rerenderContent()
  ...
  function Ae() {
    var t = this,
      e = document.getElementById("print-button");
    e &&
      e.addEventListener("click", function () {
        t.presenter.handlePrint();
      });
    var n = document.getElementById("home-button");
    n &&
      n.addEventListener("click", function () {
        t.presenter.navigateToHome();
      });
    var r = document.getElementById("check-symptom-button");
    r &&
      r.addEventListener("click", function () {
        t.presenter.navigateToCheckSymptom();
      });
  }
  var Ne = {
    "/login": function () {
    ...
    function w(t, e) {
      function n(o, a, i, s) {
        ...
        if ("throw" !== u.type) {
          var c = u.arg,
            f = c.value;
          return f && "object" == Ce(f) && r.call(f, "__await")
            ? e.resolve(f.__await).then(
                function (t) {
                  n("next", t, i, s);
                },
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          (e = r()),
                                    ...
                                    return Fe().wrap(function (t) {
                                      for (;;)
                                        switch ((t.prev = t.next)) {
                                          ...
                                          case 2:
                                            (He(Ye, u).innerHTML = t.sent),
                                              null == i || i.afterRender();
                                          case 4:
                                          case "end":
                                            return t.stop();
                                        }
                            ...
                            s.ready.catch(console.error),
                            s.updateCallbackDone.then(function () {
  ...
  function $e() {
    ...
    (t = He(Je, this)),
      (e = He(Ye, this)),
      console.log({ element: t, mainContent: e }),
  ...
  function Xe() {
    var t = this,
      e = !!s(),
      n = He(Ve, this).children.namedItem("navlist-main"),
      r = He(Ve, this).children.namedItem("navlist");
    if (
      ((n.innerHTML =
      ...
      var o = r.querySelector("#logout-button"),
        a = r.querySelector("#login-register-container");
      o &&
    ...
    function w(t, e) {
      function n(o, a, i, s) {
        ...
        if ("throw" !== u.type) {
          var c = u.arg,
            f = c.value;
          return f && "object" == Ze(f) && r.call(f, "__await")
            ? e.resolve(f.__await).then(
                function (t) {
                  n("next", t, i, s);
                },
